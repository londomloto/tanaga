...
class Encoding {
  ...
  */
  ...
  /**
   * [checkUTF8 description]
   * @param  string $text [description]
   * @return [type]       [description]
   */
  static function isUTF8 ( $text ='' ) {
      $callback = false;
      $checkUTF = mb_detect_encoding($text, 'UTF-8', true);
      if ( $checkUTF == "UTF-8" ) {
          $callback = true;
      }
      return $callback;
  ...
  /**
   * [UTF8FixWin1252Chars description]
   * @param [type] $text [description]
   */
  ...
  /**
   * [normalizeEncoding description]
   * @param  [type] $encodingLabel [description]
   * @return [type]                [description]
   */
