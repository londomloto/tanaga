...
class Mime {
	 ...
	 */
	public static function type ( $mime = null , $ext = null ) {
		self::$mimetype = array(
		    'application/octet-stream' => array('saveme'), 
		...
		$found = false;
		if ( !empty($mime) && isset(self::$mimetype[$mime])  ) {
			$mimeformat = self::$mimetype[$mime];
			if ( is_array($mimeformat) ) {
				$found = true;
			}
		}
